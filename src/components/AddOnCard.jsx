const AddOnCard = ({ setAddons, isMonthly, addons, item }) => {
  ...
  return (
    <div
      id={item[0]}
      className={`flex justify-between items-center border my-3 rounded-lg ${
        addons.some((obje) => obje.name === item[0])
    ...
    >
      <div className=" flex items-center ">
        <input
          ...
          id={item[0]}
          className="size-5 "
          checked={addons.some((obje) => obje.name === item[0])}
        />
        <div className="ml-3">
          <p className="name text-[var(--Blue-950)] font-medium" value>
            {item[0]}
          </p>
